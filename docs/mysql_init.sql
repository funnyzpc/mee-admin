...
INSERT INTO mee_admin.sys_menu  VALUES
...
INSERT INTO mee_admin.sys_menu VALUES
	 ...
	 (402,4,1,'基础管理',NULL,'',NULL,NULL,5,1,2,'2020-11-27 03:09:36.788','sys','2023-06-07 11:24:41.697','1'),
	 ...
	 (40205,402,2,'定时任务',NULL,'/sys/sys_shedlock','_content','sys:sys_shedlock:list',2,1,5,'2020-10-19 05:46:22.000','1','2023-06-07 11:26:09.187','1'),
...
INSERT INTO mee_admin.sys_menu VALUES
	 ...
	 (20701,207,2,'线下店铺',NULL,'/sv1/t_offline_store','_content','sv1:t_offline_store:list',5,1,2,'2020-11-27 03:45:34.000','admin','2023-06-16 16:45:03.568','1');
...
CREATE TABLE mee_admin.sys_shedlock (
  name varchar(64) primary key comment '任務名稱(即ID)',
  ...
  status char(1) NOT NULL DEFAULT 1 comment '0.close关闭 1.open开启(默认) 具体是否关闭取决于lock_until'
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群分佈式鎖';

INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_UPDATE_plan', '2022-02-24 05:42:00.003', '2022-02-24 05:52:00', 'shadow', 'api数据任务', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_UPDATE_province', '2022-02-24 05:44:00.003', '2022-02-24 05:54:00.001', 'shadow', 'api数据任务', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_UPDATE_tag', '2022-02-24 05:48:00.003', '2022-02-24 05:58:00.001', 'shadow', 'api数据任务', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_UPDATE_plan_hour', '2022-02-24 03:20:00.002', '2022-02-24 03:30:00', 'shadow', 'api数据任务', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_refresh_token_1', '2022-02-24 02:11:00.001', '2022-02-24 02:21:00', 'shadow', '刷新token', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_refresh_token_2', '2022-02-24 12:11:00.002', '2022-02-24 12:21:00.001', 'shadow', '刷新token', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('OEM_refresh_token_3', '2022-02-23 19:11:00.002', '2029-06-04 19:39:37.08285', 'shadow', '刷新token。。。', '0');
INSERT INTO mee_admin.sys_shedlock VALUES ('defaultTask2', '2022-12-14 09:00:00.002', '2022-12-14 09:10:00.001', 'shadow', '默认1小时/每', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('testTask3', '2023-04-22 08:59:59.991', '2029-06-04 19:43:45.648766', '192.168.1.2', '测试任务3', '0');
INSERT INTO mee_admin.sys_shedlock VALUES ('defaultTask1', '2022-09-30 15:58:00.02', '2023-08-01 15:57:00', 'ZBL00001', '默认定时任务10m/次', '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('testTask2', '2023-06-17 19:00:00.101', '2023-06-17 19:05:00.008', 'shadowdeMac-mini.local', NULL, '1');
INSERT INTO mee_admin.sys_shedlock VALUES ('testTask1', '2023-06-17 19:39:59.996', '2023-06-17 19:40:59.994', 'shadowdeMac-mini.local', NULL, '1');
