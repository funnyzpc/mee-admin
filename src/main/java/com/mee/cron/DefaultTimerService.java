...
public class DefaultTimerService {
    ...
    // 每5分钟执行一次
    @Scheduled(cron = "0 */5 * * * *")
    @SchedulerLock(name = "testTask1", lockAtMostFor = "PT1M", lockAtLeastFor = "PT1M")
    ...
    @SchedulerLock(name = "testTask2", lockAtMostFor = "PT5M", lockAtLeastFor = "PT5M")
    ...
    @SchedulerLock(name = "testTask3", lockAtMostFor = "PT10M", lockAtLeastFor = "PT10M")
