...
public class Server {
     ...
     * 磁盘相关信息
     */
    private List<Disk> sysFiles = new LinkedList<Disk>();
    ...
    public List<Disk> getSysFiles()
    {
        return sysFiles;
    }

    public void setSysFiles(List<Disk> disks)
    {
        this.sysFiles = disks;
    }
    ...
    private void setSysFiles(OperatingSystem os)
    {
        ...
        for (OSFileStore fs : fsArray)
        {
            ...
            disk.setUsage(ArithUtil.mul(ArithUtil.div(used, total, 4), 100));
            sysFiles.add(disk);
        }
    }
